  ...
  static Route<dynamic> generateRoute(RouteSettings settings){
    final arg = settings.arguments;
     ...
     switch(settings.name){
       case RouteName.main:
         return MaterialPageRoute( settings: _routeSettings(settings), builder: (context) => main);
       case RouteName.station:
         return MaterialPageRoute( settings: _routeSettings(settings), builder: (context) => const PageStation());
       default:
